<?php 
$amount = $_GET['amount'];
$hswd_account_number = $_GET['hswd_account_number'];
...
<area shape="rect" coords="369,53,513,126" alt="Download Forms" href="forms.html" />
 ...
 <table id="topnav" align="center" width="947" cellpadding="0" cellspacing="0" border="0">
  ...
  <tr>
   <td id="main-col" align="left" valign="top"><br /><br /><br /><br /><br /><br />
   <div align="center">Thank you for your payment.<br /> HSWD will be notified of your payment in the amount of: <?php echo $amount; ?> to your account: <?php echo $hswd_account_number; ?>.<br />Your conformation number is: <?php echo $confirmation; ?></div><br /><br /><br /><br /><br /><br /><br /></td>
  </tr>
 </table>
